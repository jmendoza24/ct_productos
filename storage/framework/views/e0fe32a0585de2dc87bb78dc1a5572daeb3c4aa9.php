    ...
    <div role="tabpanel" class="tab-pane active in" id="active32" aria-labelledby="active-tab32" aria-expanded="true">
        <div class="row">   
            ...
            <div id="div_masivos" style="overflow: auto;width: 100%;height: 300px">
              ...
              <form method="post" action="<?php echo e(route('subidas')); ?>" class="form-horizontal" enctype='multipart/form-data'>
                 <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\laravel\tp\resources\views/Masivos/index.blade.php ENDPATH**/ ?>