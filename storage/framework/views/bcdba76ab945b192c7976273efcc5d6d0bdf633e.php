...
<head>
  ...
  <link rel="apple-touch-icon" href="<?php echo e(url('app-assets/images/ico/logo.png')); ?>">
  <link rel="shortcut icon" type="image/x-icon" href="<?php echo e(url('app-assets/images/ico/logo.png')); ?>">
  <meta name="csrf-token" content="<?php echo e(csrf_token()); ?>">
  <link href="https://fonts.googleapis.com/css?family=Montserrat:300,300i,400,400i,500,500i%7COpen+Sans:300,300i,400,400i,600,600i,700,700i"
  rel="stylesheet">
 <link href="https://fonts.googleapis.com/icon?family=Material+Icons"
      rel="stylesheet">
 <?php echo $__env->make('layouts.data_css_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<link rel="stylesheet" type="text/css" href="<?php echo e(url('app-assets/css/plugins/forms/switch.css')); ?>">
...
data-open="click" data-menu="vertical-menu-modern" data-col="2-columns">
  ...
  <script src="<?php echo e(url('app-assets/vendors/js/tables/buttons.colVis.min.js')); ?>" type="text/javascript"></script>
  <!-- END PAGE VENDOR JS-->
  <!-- BEGIN STACK JS-->
  ...
  <script type="text/javascript" src="<?php echo e(url('js/jquery.steps.js')); ?>"></script>
  <script type="text/javascript" src="<?php echo e(url('js/jquery.steps.min.js')); ?>"></script>

  <script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-fileinput/4.4.7/js/fileinput.js" type="text/javascript"></script>
  <script src="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-fileinput/4.4.7/themes/fa/theme.js" type="text/javascript"></script>
  <script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.11.0/umd/popper.min.js" type="text/javascript"></script>
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0-beta/js/bootstrap.min.js" type="text/javascript"></script>
  <script type="text/javascript" src="<?php echo e(url('js/es.js')); ?>"></script>
  ...
  <script src="<?php echo e(url('assets/js/material-kit.js')); ?>"></script>
  ...
  <script type="text/javascript">
   ...
   <?php if(empty($tblEmpresas->logo)): ?>
        ...
        $("#logo").fileinput({
            ...
            browseClass: "btn btn_azul",
            initialPreview: [
                "data:image/pdf/jpeg;base64,<?php echo e(base64_encode(Storage::get($tblEmpresas->logo))); ?>"
            ],
        ...
        $("#foto1").fileinput({
            ...
            browseClass: "btn btn_azul",
            initialPreview: [
                "data:image/pdf/jpeg;base64,<?php echo e(base64_encode(Storage::get($tblProductos->foto1))); ?>"
            ],
            initialPreviewConfig: [
        ...
        <?php if(empty($tblProductos->foto2)): ?>
        ...
        $("#foto2").fileinput({
            ...
            browseClass: "btn btn_azul",
            initialPreview: [
                "data:image/pdf/jpeg;base64,<?php echo e(base64_encode(Storage::get($tblProductos->foto2))); ?>"
            ],
            initialPreviewConfig: [
        ...
        <?php if(empty($tblProductos->foto3)): ?>
        ...
        $("#foto3").fileinput({
            ...
            browseClass: "btn btn_azul",
            initialPreview: [
                "data:image/pdf/jpeg;base64,<?php echo e(base64_encode(Storage::get($tblProductos->foto3))); ?>"
            ],
            initialPreviewConfig: [
        ...
        <?php if(empty($tblProductos->foto4)): ?>
        ...
        $("#foto4").fileinput({
            ...
            browseClass: "btn btn_azul",
            initialPreview: [
                "data:image/pdf/jpeg;base64,<?php echo e(base64_encode(Storage::get($tblProductos->foto4))); ?>"
            ],
            initialPreviewConfig: [
        ...
        <?php if(empty($tblProductos->foto5)): ?>
        ...
        $("#foto5").fileinput({
            ...
            browseClass: "btn btn_azul",
            initialPreview: [
                "data:image/pdf/jpeg;base64,<?php echo e(base64_encode(Storage::get($tblProductos->foto5))); ?>"
            ],
            initialPreviewConfig: [
...
</html><?php /**PATH /home/altermed/public_html/tpmonterrey.cotiza.tech/laravel/resources/views/layouts/master.blade.php ENDPATH**/ ?>