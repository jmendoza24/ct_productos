           ...
           <tr style="width: 100%" class="gris_barra" style="color: gray" >
                        ...
                        <div class="form-group row" style="width: 100px;">
                         <select style="text-align: right;text-align-last: right;width: 100%" class="form-control" id="descuento_aplicado" name="descuento_aplicado" onchange="actualiza2(<?php echo e($num_cot); ?>)">
                          <?php if($actual->descuento=='00.00'): ?>
                                <option style="text-align: right;text-align-last: right;" value="0" <?php echo e(($actual->descuento_aplicado==0) ? 'selected' : ''); ?>>00.00%</option>

                          <?php else: ?>
                                <option style="text-align: right;text-align-last: right;" value="0" <?php echo e(($actual->descuento_aplicado==0) ? 'selected' : ''); ?>>00.00%</option>
                                <option style="text-align: right;text-align-last: right;" value="<?php echo e($actual->descuento); ?>" <?php echo e(($actual->descuento==$actual->descuento_aplicado) ? 'selected' : ''); ?> ><?php echo e($actual->descuento); ?>%</option>
            ...
            <tr style="width: 100%"  style="color: gray; background-color: white" >
                   ...
                   <div class="col-md-6"> 
                        <div class="form-group row" style="width: 100px;">
                         <select style="text-align: right;text-align-last: right;width: 100%" class="form-control" id="iva" name="iva" onchange="actualiza2(<?php echo e($num_cot); ?>)">
                           <option style="text-align: right;text-align-last: right;" value="0"  <?php echo e(($actual->iva==0) ? 'selected' : ''); ?>>00.00%</option>
                           <option style="text-align: right;text-align-last: right;" value="8"  <?php echo e(($actual->iva==8) ? 'selected' : ''); ?>>08.00%</option>
                           <option style="text-align: right;text-align-last: right;" value="16" <?php echo e(($actual->iva==16) ? 'selected' : ''); ?>>16.00%</option>
                         </select> 
                        </div>
                  </div> 
                </td>
             ...
             <tr style="width: 100%"  style="color: gray;" >
                ...
                <td colspan="3" style="text-align: right;background-color: white"><textarea  style="height: 200px" class="form-control" onchange="actualiza2(<?php echo e($num_cot); ?>)" id="condiciones_encot"><?php echo e($actual->condiciones); ?></textarea></td> 
                   ...
                   <div class="col-md-6"> 
                        <div class="form-group row" style="width: 100px;">
                          <?php if(empty($actual->anticipo)): ?>
                           <input type="text" style="background-color:whitesmoke;text-align: left;text-align: right;text-align-last: right;"   name="anticipo" id="anticipo" class="form-control percentage-mask" value="00.00" onchange="actualiza2(<?php echo e($num_cot); ?>)">

                          <?php else: ?>
                             <input type="text" style="background-color:whitesmoke;text-align: left;text-align: right;text-align-last: right;" name="anticipo" id="anticipo" class="form-control percentage-mask" value="<?php echo e($actual->anticipo); ?>" onchange="actualiza2(<?php echo e($num_cot); ?>)">
                          <?php endif; ?>
                        </div>
                  </div> 
                </td>
...
<?php /**PATH /home/altermed/public_html/tpmonterrey.cotiza.tech/laravel/resources/views/tbl_cotizaciones/table_cotizacion2.blade.php ENDPATH**/ ?>