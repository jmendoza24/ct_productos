        ...
        <?php $__currentLoopData = $tblCotizaciones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tblCotizaciones): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php if($tblCotizaciones->estatus==1): ?>
            <tr style="background-color: white">
                <td><p style=""><?php echo e($tblCotizaciones->id); ?></p></td>
                ...
                <td>      
                    <div class='btn-group'>   
                        <a title="Convertir a Cot." onclick="convertir_cot(<?php echo e($tblCotizaciones->id); ?>)" href="#" class='btn btn-link'><span class="texto_verde material-icons md-20">sync_alt</span></a> 
...
<?php /**PATH /home/altermed/public_html/cotiza.tech/laravel/resources/views/tbl_oc/oc_table.blade.php ENDPATH**/ ?>