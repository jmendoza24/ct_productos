...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="{{ url('app-assets/css-rtl/core/menu/menu-types/vertical-menu-modern.css')}}">
  <link rel="stylesheet" type="text/css" href="{{ url('app-assets/css-rtl/core/colors/palette-gradient.css')}}">
  <link rel="stylesheet" type="text/css" href="{{ url('app-assets/css-rtl/pages/error.css')}}">
  <!-- END Page Level CSS-->
  <!-- BEGIN Custom CSS-->
          ...
          <div class="col-12 d-flex align-items-center justify-content-center">
            <div class="col-md-4 col-10 p-0">
              <div class="card-header bg-transparent border-0">
                ...
                <h3 class="text-uppercase text-center">¡ No es posible procesar su solicitud !</h3>
              </div>
