  ...
  <div id="accordion" role="tablist">
        <div class="card card-collapse ">
          ...
          <div id="collapseOne" class="collapse" role="tabpanel" aria-labelledby="headingOne" data-parent="#accordion" style="">
            <div class="card-body">
                   <h1 class="pull-right">
                         <a  class="btn btn_azul pull-right" style="margin-top: -10px;margin-bottom: 5px" data-toggle="modal" data-target="#myModal" onclick="tipo_cliente(0,0)"  href="#{{-- {!! route('tblVendedores.create') !!} --}}"> <span class="material-icons md-18">add</span> Tipo cliente</a>
                  </h1>
                  <div id="div_tipo_cliente" style="overflow: auto;width: 100%">
                      @include('tbl_tipo_clientes.table')
                </div>
            </div>
          </div>
        </div>
        <div class="card card-collapse ">
          ...
          <div id="collapseOne9" class="collapse" role="tabpanel" aria-labelledby="headingOne9" data-parent="#accordion" style="">
            <div class="card-body">
                   <h1 class="pull-right">
                         <a  class="btn btn_azul pull-right" style="margin-top: -10px;margin-bottom: 5px" data-toggle="modal" data-target="#myModal" onclick="tipo_vendedor(0,0)"  href="#{{-- {!! route('tblVendedores.create') !!} --}}"> <span class="material-icons md-18">add</span> Tipo vendedor</a>
                  </h1>
                  <div id="div_tipo_vendedores" style="overflow: auto;width: 100%">
                      @include('tbl_tipo_vendedors.table')
                </div>
            </div>
          </div>
        </div>
          ...
          <div id="collapseOne9000" class="collapse" role="tabpanel" aria-labelledby="headingOne9000" data-parent="#accordion" style="">
            <div class="card-body">
                  ...
                  <div id="div_fabricantes" style="overflow: auto;width: 100%">
                      @include('tbl_fabricantes.catalogo_fabricante')
                </div>
            </div>
          </div>
        </div>
        ...
        <div class="card card-collapse ">
          ...
          <div id="collapseOne90" class="collapse" role="tabpanel" aria-labelledby="headingOne90" data-parent="#accordion" style="">
            <div class="card-body">
                   <h1 class="pull-right">
                         <a  class="btn btn_azul pull-right" style="margin-top: -10px;margin-bottom: 5px" data-toggle="modal" data-target="#myModal" onclick="categoria(0,0)"  href="#{{-- {!! route('tblVendedores.create') !!} --}}"> <span class="material-icons md-18">add</span> Categoría</a>
                  </h1>
                  <div id="div_categorias" style="overflow: auto;width: 100%">
                      @include('tbl_categorias.table')
                </div>
            </div>
          </div>
        </div>
        <div class="card card-collapse ">
          ...
          <div id="collapseOne901" class="collapse" role="tabpanel" aria-labelledby="headingOne901" data-parent="#accordion" style="">
            <div class="card-body">
                   <h1 class="pull-right">
                         <a  class="btn btn_azul pull-right" style="margin-top: -10px;margin-bottom: 5px" data-toggle="modal" data-target="#myModal" onclick="sub_categoría(0,0)"  href="#{{-- {!! route('tblVendedores.create') !!} --}}"> <span class="material-icons md-18">add</span> Sub categoría</a>
                  </h1>
                  <div id="div_subcategorias" style="overflow: auto;width: 100%">
                      @include('tbl_subcategorias.table')
                </div>
            </div>
          </div>
        </div>
        ...
        <div class="card card-collapse ">
          ...
          <div id="collapseOne90a" class="collapse" role="tabpanel" aria-labelledby="headingOne90a" data-parent="#accordion" style="">
            <div class="card-body">
                   <h1 class="pull-right">
                         <a  class="btn btn_azul pull-right" style="margin-top: -10px;margin-bottom: 5px" data-toggle="modal" data-target="#myModal" onclick="colores(0,0)"  href="#{{-- {!! route('tblVendedores.create') !!} --}}"> <span class="material-icons md-18">add</span> Color</a>
                  </h1>
                  <div id="div_colores" style="overflow: auto;width: 100%">
                      @include('tbl_colors.table')
                </div>
            </div>
          </div>
        </div>
        <div class="card card-collapse ">
            ...
            <div id="collapseOne1" class="collapse" role="tabpanel" aria-labelledby="headingOne1" data-parent="#accordion" style="">
              <div class="card-body">
                     <h1 class="pull-right">
                           <a  class="btn btn_azul pull-right" style="margin-top: -10px;margin-bottom: 5px" data-toggle="modal" data-target="#myModal" onclick="unidad(0,0)"  href="#{{-- {!! route('tblVendedores.create') !!} --}}"> <span class="material-icons md-18">add</span> Unidad</a>
                    </h1>
          ...
          <div class="card card-collapse ">
            ...
            <div id="collapseOne5" class="collapse" role="tabpanel" aria-labelledby="headingOne5" data-parent="#accordion" style="">
              <div class="card-body">
                     <h1 class="pull-right">
                           <a  class="btn btn_azul pull-right" style="margin-top: -10px;margin-bottom: 5px" data-toggle="modal" data-target="#myModal" onclick="moneda(0,0)"  href="#{{-- {!! route('tblVendedores.create') !!} --}}"> <span class="material-icons md-18">add</span> Moneda</a>
                    </h1>
                    <div id="div_monedas" style="overflow: auto;width: 100%">
                        @include('tbl_monedas.table')
                  </div>
              </div>
            </div>
          </div>
          ...
          <div class="card card-collapse ">
            ...
            <div id="collapseOne2" class="collapse" role="tabpanel" aria-labelledby="headingOne2" data-parent="#accordion" style="">
              <div class="card-body">
                    ...
                    <div id="div_tipo_cliente" style="overflow: auto;width: 100%">
                        @include('tbl_tipo_clientes.table_paises')
                  </div>
              </div>
            </div>
          </div>
          ...
          <div class="card card-collapse ">
            ...
            <div id="collapseOne2as" class="collapse" role="tabpanel" aria-labelledby="headingOne2as" data-parent="#accordion" style="">
              <div class="card-body">
                    ...
                    <div id="div_tipo_cliente" style="overflow: auto;width: 100%">
                        @include('tbl_tipo_clientes.table_estatus')
                  </div>
              </div>
            </div>
          </div>
          ...
          <div class="card card-collapse ">
            ...
            <div id="collapseOne3" class="collapse" role="tabpanel" aria-labelledby="headingOne3" data-parent="#accordion" style="">
              <div class="card-body"> 
                    ...
                    <div id="div_tipo_cliente" style="overflow: auto;width: 100%">
                        @include('tbl_tipo_clientes.table_estados')
                  </div>
              </div>
            </div>
          </div>
          ...
          <div class="card card-collapse ">
            ...
            <div id="collapseOne4" class="collapse" role="tabpanel" aria-labelledby="headingOne4" data-parent="#accordion" style="">
              <div class="card-body">
                    ...
                    <div id="div_tipo_cliente" style="overflow: auto;width: 100%">
                        @include('tbl_tipo_clientes.table_municipios')
                  </div>
              </div>
            </div>
          </div>
          <div class="card card-collapse ">
          <div class="card-header" role="tab" id="headingOneTa">
            <h5 class="mb-0">
              <a data-toggle="collapse" href="#collapseOneTa" aria-expanded="false" aria-controls="collapseOneTa" class="collapsed">
                 &nbsp; &nbsp;<h2 class="textos"> Tallas
                <i class="material-icons">add</i></h2>
              </a>
            </h5>
          </div>
          <div id="collapseOneTa" class="collapse" role="tabpanel" aria-labelledby="headingOneTa" data-parent="#accordion" style="">
            <div class="card-body">
                   <h1 class="pull-right">
                      <a  class="btn btn_azul pull-right white" style="margin-top: -10px;margin-bottom: 5px" data-toggle="modal" data-target="#myModal" onclick="ver_catalogo(1,0,1,0)" > <span class="material-icons md-18">add</span> Talla</a>
                  </h1>
                  <div id="catalogos_tallas">
                      @include('catalogos.table_tallas')
                </div>
            </div>
          </div>
        </div>
