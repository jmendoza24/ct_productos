...
<div id="base">
 <div class="col-md-12"><h4><strong class="texto_azul">Alta de costos de servicios para direcciones</strong></h4></div>
  ...
  <div id="accordion" role="tablist">
        <div class="card card-collapse ">
          ...
          <div id="collapseOne" class="collapse" role="tabpanel" aria-labelledby="headingOne" data-parent="#accordion" style="">
            <div class="card-body">
                <h1 class="pull-right">
                         <a  class="btn btn_azul pull-right" style="margin-top: -10px;margin-bottom: 5px" data-toggle="modal" data-target="#myModal" onclick="costo_servicio(0,0,1)"  href="#{{-- {!! route('tblVendedores.create') !!} --}}"> <span class="material-icons md-18">add</span> Costo</a>
                  </h1>
                  <div id="div_registro_civil_costo" style="overflow: auto;width: 100%">
                    @include('tbl_costos_servicios.table')
                </div>
            </div>
          </div>
        </div>
