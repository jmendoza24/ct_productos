    ...
    <tbody>
      ...
      @php($anticipo=0) 
       @foreach($cotizados as $cotizados)
            ...
            <td>
              <div class='btn-group'>   
                    <a title="Borrar" onclick="borra_registro_detalle({{ $cotizados->idp }},{{ $num_cot }})" href="#" class='btn btn-link'><span class="texto_gris material-icons md-20">delete_sweep</span></a> 
                </div>
            </td>
        </tr>
           ...
           <tr style="width: 100%" class="gris_barra" style="color: gray" >
            ...
            <tr style="width: 100%"  style="color: gray; background-color: white" >
             ...
             <tr style="width: 100%"  style="color: gray;" >
                ...
                <td colspan="3" style="text-align: right;background-color: white"><textarea  style="height: 1200px;width: 600px" cols="40" rows="5"  class="form-control " onchange="actualiza2({{ $num_cot }})" id="condiciones_encot">{{ $actual->condiciones }}</textarea></td> 
                   ...
                   <div class="col-md-6"> 
                        <div class="form-group row" style="width: 100px;">
                          @if(empty($actual->anticipo))
                           <input type="text" style="background-color:whitesmoke;text-align: left;text-align: right;text-align-last: right;width: 100%" name="anticipo" id="anticipo" class="form-control percentage-mask" value="00.00" onchange="actualiza2({{ $num_cot }})">

                          @else
                             <input type="text" style="background-color:whitesmoke;text-align: left;text-align: right;text-align-last: right;width: 100%" name="anticipo" id="anticipo" class="form-control percentage-mask" value="{{ $actual->anticipo }}" onchange="actualiza2({{ $num_cot }})">
                          @endif
                        </div>
                  </div> 
                </td>
