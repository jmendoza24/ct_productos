...
<head>
  <meta charset="utf-8" />
  <link rel="apple-touch-icon" sizes="76x76" href="{{ url('app-assets/images/ico/logo.png')}}">
  <link rel="icon" type="image/png" href="{{ url('app-assets/images/ico/logo.png')}}">
...
<body class="login-page sidebar-collapse">
        ...
        <div class="col-lg-4 col-md-6 ml-auto mr-auto">   
          ...
          <div class="card card-login">  <br>
             <div class="card-title text-center">
                <img style="width: 50%" src="{{ url('app-assets/images/ico/logo.png')}}">
            </div>
  ...
  <script src="{{ url('assets/js/material-kit.js?v=2.0.7')}}" type="text/javascript"></script>
</body>
